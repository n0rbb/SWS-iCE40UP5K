create_clock -name {clk_fpga_external} -period 83.3333333333333 -add [get_ports CLK_SOURCE]
create_clock -name {clk_oscillators} -period 8.33333333333333 -add [get_pins UUT_SWS/FC0_CP/FAST_CLK_PORT]
#DISABLED# create_clock -name {clk_fpga_internal} -period 83.3333333333333 [get_nets clk_fpga]
